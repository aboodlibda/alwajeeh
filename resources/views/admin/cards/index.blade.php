                                ...
                                @foreach($cards as $card)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="text-white fw-bolder  mb-1 fs-6 badge badge-primary">{{$card->year . '/' . $card->month}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="text-white fw-bolder  mb-1 fs-6 badge badge-danger">{{$card->cvc}}</span>
                                                </div>
                                            </div>
                                        </td>
