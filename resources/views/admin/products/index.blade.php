        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-1"> المنتجات</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">جميع المنتجات</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">جميع المنتجات</span>
                        </h3>
                        <div class="card-toolbar">
                            <a href="{{route('products.create')}}" class="btn btn-sm btn-light-primary">
                                ...
                                <!--end::Svg Icon-->إضافة منتج جديد</a>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                <tr class="fw-bolder text-muted bg-light">
                                    ...
                                    <th class="ps-4 rounded-start">اسم المنتج</th>
                                    <th class="ps-4 rounded-start">التصنيف</th>
                                    <th class="ps-4 rounded-start">السعر</th>
                                ...
                                @foreach($products as $product)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50px ">
                                                    <img src="{{asset('products-images/'.$product->image)}}" class="" alt="">
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="text-white fw-bolder  mb-1 fs-6 badge badge-primary">{{$product->category->name}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="text-white fw-bolder  mb-1 fs-6 badge badge-danger">{{$product->price}} ر.س </span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="{{$product->status == 'active' ? "badge badge-success " : "badge badge-danger"}} fw-bolder  mb-1 fs-6">
                                                                {{$product->status == 'active' ? 'ظاهر' : 'غير ظاهر'}}
                                                    </span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{route('products.edit',$product)}}" class="btn btn-icon btn-bg-light btn-active-color-primary ">
                                            ...
                                            <button type="button"  data-bs-toggle="modal" data-bs-target="#kt_modal_1"  data-id="{{ $product->id }}"  class="btn btn-icon btn-bg-light btn-active-color-danger ">
