        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-1">الإعدادات العامة</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">جميع الإعدادات العامة</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 rounded-start">واتس اب</th>
                                    <th class="ps-4">بريد إلكتروني</th>
                                    <th class="ps-4">معروف</th>
                                    <th class="ps-4">الحساب البنكي</th>
                                ...
                                @foreach($settings as $setting)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="text-dark fw-bolder  mb-1 fs-6">{{$setting->whatsapp}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="text-dark fw-bolder  mb-1 fs-6">{{$setting->email}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="text-dark fw-bolder  mb-1 fs-6">{{$setting->ma3roof}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span class="text-dark fw-bolder  mb-1 fs-6">{{$setting->bank_account}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <a href="{{route('settings.edit',$setting)}}" class="btn btn-icon btn-bg-light btn-active-color-primary ">
