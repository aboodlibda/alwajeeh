        ...
        <section class="container-fluid mt-3">
            <div class="row">
                <div class="rounded-4 shadow col-md-4 col-11 ms-auto me-auto px-4 py-3 my-md-5 my-3 border">
                    ...
                    <div class="text-center mt-2 mb-4">
                        <p class="fs-6 text-secondary">بنك الراجحي - IBANPAL1684351645614651531</p>
                        <p class="fs-6 text-secondary"> بنك الأهلي - RAJSAR54518616546515686651</p>
                    </div>
                    ...
                    <div class="text-center my-3">
                        <a href="https://wa.me/966598692675" class="btn btn-outline-success w-100">
